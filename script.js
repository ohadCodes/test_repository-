...
window.deleteDupe = deleteDupe;
window.deleteAllDupes = deleteAllDupes;
...
window.selectAllDelete = selectAllDelete;
window.deselectAllDelete = deselectAllDelete;
...
window.approveFeedbackItem = approveFeedbackItem;
window.deleteFeedbackItem = deleteFeedbackItem;
window.loadSimilar = loadSimilar;
window.mergeGroup = mergeGroup;
